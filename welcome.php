...
function process_file($f){
  ...
  elseif(substr($name, -4)!=".txt"){
    ...
    unlink($_SERVER['DOCUMENT_ROOT']."/myDepartment/myresources/welcome.txt");
    move_uploaded_file($_FILES["file"]["tmp_name"],$_SERVER['DOCUMENT_ROOT'] .'/myDepartment/myresources/'.$_FILES['file']['name']);
    rename("myresources/".$_FILES['file']['name'],"myresources/welcome.txt");
    $f=1;
  }
  return $f;
}
  ...
  $content="<div class=\"col-md-9\"><div id=\"content\">
      ...
      <br>  <br>  <br>
      ".$alert."
      <form action=\"welcome.php\" id=\"edit_page\" method=\"POST\">
      ...
      <form enctype=\"multipart/form-data\" action=\"welcome.php\" method=\"post\">
        <label><h3>Replace the welcome page with a new txt file:</h3></label>
